...
export default function ContractBalanceDebug() {
  ...
  const getDebugInfo = () => {
    const info = {
      ...
      contract: {
        address: process.env.NEXT_PUBLIC_TRIVIA_CONTRACT_ADDRESS || '0x9b33f82357CC0a263A533599633fB0AA5CFD907c',
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-4 bg-blue-50 rounded-lg">
          ...
          <div className="space-y-1 text-sm">
            <div><strong>Contract Address:</strong> {process.env.NEXT_PUBLIC_TRIVIA_CONTRACT_ADDRESS || '0x9b33f82357CC0a263A533599633fB0AA5CFD907c'}</div>
