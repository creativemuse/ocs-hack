...
export default function ContractBalanceDebug() {
  ...
  const getDebugInfo = () => {
    const info = {
      ...
      contract: {
        address: process.env.NEXT_PUBLIC_TRIVIA_CONTRACT_ADDRESS || '0x2E48c2aae9CC1dF9Ca4e5Cd67be17f299B86eB4f',
      ...
      <CardContent className="space-y-4">
        ...
        <div className="p-4 bg-blue-50 rounded-lg">
          ...
          <div className="space-y-1 text-sm">
            <div><strong>Contract Address:</strong> {process.env.NEXT_PUBLIC_TRIVIA_CONTRACT_ADDRESS || '0x2E48c2aae9CC1dF9Ca4e5Cd67be17f299B86eB4f'}</div>
